                ...
                <div class="card-header pb-0">
                    @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                        <div class="d-flex justify-content-between">
                            <a class="modal-effect btn btn-sm btn-outline-primary" data-effect="effect-scale"
                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                                <a class="modal-effect btn btn-sm btn-outline-success"
                                                    data-effect="effect-scale" data-id="{{ $product->id }}"
                                                    data-product_name="{{ $product->product_name }}"
                                                    data-description="{{ $product->description }}" data-toggle="modal"
                                                    href="#editModel" title="تعديل">تعديل</a>
                                            @endif
                                            ...
                                            @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                                <a class="modal-effect btn btn-sm btn-outline-danger"
                                                    ...
                                                    href="#deleteModel" title="حذف">حذف</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
