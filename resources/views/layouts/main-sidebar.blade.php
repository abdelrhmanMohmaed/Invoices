...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">برنامج الفاواتيرة</li>
            <li class="slide">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_partial')) }}">الفواتير
                            المدفوعه
                            جزئيا</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_active')) }}">
                            الارشيف
                        </a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'report_customers')) }}">تقارير
                            العملاء</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'product')) }}">المنتاجات</a>
                    </li>
                </ul>
            </li>
        </ul>
